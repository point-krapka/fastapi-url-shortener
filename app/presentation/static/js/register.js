    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                showFieldError(loginInput, loginError, 'This username is already taken');
                showFeedback('User with this username already exists', 'error');
                
            } else if (response.status === 401) {
                showFeedback('Authentication error', 'error');
